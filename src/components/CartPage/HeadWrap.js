...
class HeadWrap_CartPage extends React.Component {
  render() {
    return (
        <div className="headwrap-container">
          ...
          <div style={{display: 'inline-block', left: 100}}
            ...
            <Steps>
              <Step status="process" title="我的购物车"
                    icon={<ShoppingCartOutlined/>}/>
              <Step status="wait" title="填写订单" icon={<ShoppingOutlined/>}/>
              <Step status="wait" title="完成订单" icon={<SmileOutlined/>}/>
            </Steps>
          </div>
...
export default HeadWrap_CartPage;